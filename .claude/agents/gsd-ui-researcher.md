...
Use template from `/home/deck/claude/blizz/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/deck/claude/blizz/.claude/get-shit-done/templates/UI-SPEC.md`
