...
Reference full template: `/home/deck/claude/blizz/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/deck/claude/blizz/.claude/get-shit-done/templates/state.md`.
