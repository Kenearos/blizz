...
```bash
INIT=$(node "/home/deck/claude/blizz/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/deck/claude/blizz/.claude/get-shit-done/templates/spec.md.
