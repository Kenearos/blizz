...
```markdown
Read /home/deck/claude/blizz/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/deck/claude/blizz/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/deck/claude/blizz/.claude/agents/gsd-ui-checker.md for instructions.
