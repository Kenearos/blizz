...
```bash
INIT=$(node "/home/deck/claude/blizz/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/deck/claude/blizz/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
