...
```
Agent(
  prompt="Read /home/deck/claude/blizz/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/deck/claude/blizz/.claude/get-shit-done/templates/SECURITY.md`
