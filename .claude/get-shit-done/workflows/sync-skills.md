...
INSTALL_JS_GLOBAL="/home/deck/claude/blizz/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/deck/claude/blizz/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
